export default function Skills() {
  const skillCategories = [
    {
      title: "Frontend",
      skills: ["React.js", "HTML/CSS/JS", "Tailwind/Bootstrap", "jQuery"],
      icon: (
        <svg
    ...
    {
      title: "Backend",
      skills: ["Django/DRF", "Laravel/PHP", "Node.js/Express", "PostgreSQL/MySQL/Mongo"],
      icon: (
        <svg
          className="w-5 h-5 text-accent"
          fill="none"
    ...
    {
      title: "AI/ML",
      skills: ["scikit-learn/Pandas", "PyTorch/Transformers", "OpenAI Agent SDK", "ChromaDB"],
      icon: (
        <svg
          className="w-5 h-5 text-accent"
          fill="none"
    ...
    {
      title: "Tooling",
      skills: ["Git/GitHub", "Firebase", "Kotlin/Android", "WordPress/Design"],
      icon: (
        <svg
          className="w-5 h-5 text-accent"
          fill="none"
